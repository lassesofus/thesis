...
BASE_OUT_DIR="/home/s185927/thesis/experiments/01_zero_shot_single_axis_reaching/follow_up_experiments/effect_of_camera_angles"
...
COMMON_ARGS="--render offscreen --fixed_target --planning_steps 5 --save_distance_data --action_transform swap_xy_negate_x --enable_vjepa_planning --save_planning_images --gripper robotiq --reset_sim --teleport_actions"
