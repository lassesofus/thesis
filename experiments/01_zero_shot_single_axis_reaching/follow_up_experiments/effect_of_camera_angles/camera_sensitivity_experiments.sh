...
COMMON_ARGS="--render offscreen --fixed_target --planning_steps 5 --save_distance_data --action_transform swap_xy_negate_x --enable_vjepa_planning --save_planning_images --gripper robotiq"
