...
COMMON_ARGS="--render offscreen --fixed_target --planning_steps 5 --save_distance_data --max_episodes 10 --action_transform swap_xy_negate_x --enable_vjepa_planning --camera_name left_cam --gripper robotiq --reset_sim --teleport_actions"
