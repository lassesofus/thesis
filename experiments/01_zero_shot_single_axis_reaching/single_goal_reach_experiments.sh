...
OUT_DIR="/home/s185927/thesis/experiments/01_zero_shot_single_axis_reaching/left_cam_cem_optimized_teleport"
COMMON_ARGS="--render offscreen --out_dir ${OUT_DIR} --fixed_target --planning_steps 5 --save_distance_data --max_episodes 10 --action_transform swap_xy_negate_x --enable_vjepa_planning --save_planning_images --visualize_energy_landscape --camera_name left_cam --gripper robotiq --reset_sim --teleport_actions"
