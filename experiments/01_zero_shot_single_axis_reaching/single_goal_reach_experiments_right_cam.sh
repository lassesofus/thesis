#!/usr/bin/env bash
# filepath: /home/s185927/thesis/experiments/01_zero_shot_single_axis_reaching/single_goal_reach_experiments_right_cam.sh
...
OUT_DIR="/home/s185927/thesis/experiments/01_zero_shot_single_axis_reaching/right_cam"
COMMON_ARGS="--render offscreen --out_dir ${OUT_DIR} --fixed_target --planning_steps 5 --save_distance_data --max_episodes 1 --action_transform swap_xy_negate_x --enable_vjepa_planning --camera_name right_cam"
