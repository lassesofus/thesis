...
def create_configs(
    ...
    for pct in percentages:
        ...
        cfg['meta']['early_stopping_patience'] = 10
        cfg['meta']['val_freq'] = 1
        cfg['meta']['early_stopping_min_delta'] = 0.0001

        # 8. Save checkpoints more frequently for analysis
        cfg['meta']['save_every_freq'] = 25

        # 9. DISABLE ALL DATA AUGMENTATION
        # Due to small dataset size and to avoid overfitting to transformations
        # not present at inference time
        cfg['data_aug']['auto_augment'] = False
        cfg['data_aug']['horizontal_flip'] = False
        cfg['data_aug']['motion_shift'] = False
        cfg['data_aug']['random_resize_aspect_ratio'] = [1.0, 1.0]
        cfg['data_aug']['random_resize_scale'] = [1.0, 1.0]
        cfg['data_aug']['reprob'] = 0.0
...
def main():
    ...
    parser.add_argument(
        "--splits_dir",
        type=str,
        default="/data/s185927/droid_sim/axis_aligned/x_axis/splits",
