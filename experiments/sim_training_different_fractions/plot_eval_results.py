#!/usr/bin/env python3
"""
Plot V-JEPA model evaluation results.

Usage:
    python plot_eval_results.py /home/s185927/thesis/experiments/sim_training_different_fractions/eval_results_full
"""
...
def load_results(eval_dir):
    ...
    # Load individual results (n50 files only)
    individual_results = {}
    for result_file in eval_path.glob("*_n75.json"):
        model_name = result_file.stem.replace("_results_n75", "")
...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python plot_eval_results.py /home/s185927/thesis/experiments/sim_training_different_fractions/eval_results_full")
        sys.exit(1)
