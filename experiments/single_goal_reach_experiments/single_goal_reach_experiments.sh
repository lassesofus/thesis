...
OUT_DIR="/home/s185927/thesis/robohive/robohive/robohive/experiments"
COMMON_ARGS="--render offscreen --out_dir ${OUT_DIR} --fixed_target --planning_steps 5 --save_distance_data --max_episodes 10 --action_transform swap_xy_negate_x --enable_vjepa_planning"
