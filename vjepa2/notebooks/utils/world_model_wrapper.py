...
# AMP optimization flag - OPT_AMP takes precedence if explicitly set
if 'OPT_AMP' in os.environ:
    USE_AMP = os.environ.get('OPT_AMP') == '1'
else:
    USE_AMP = os.environ.get('VJEPA_OPTIMIZE', '0') == '1'
